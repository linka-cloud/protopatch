...
var file_tests_lint_lint_proto_rawDesc = []byte{
	...
	0x05, 0x0a, 0x01, 0x42, 0x10, 0x02, 0x12, 0x05, 0x0a, 0x01, 0x43, 0x10, 0x03, 0x42, 0x3c, 0xca,
	0xb5, 0x03, 0x12, 0x08, 0x01, 0x52, 0x03, 0x52, 0x47, 0x42, 0x52, 0x04, 0x52, 0x47, 0x42, 0x41,
	0x52, 0x03, 0x48, 0x53, 0x56, 0x5a, 0x24, 0x67, 0x6f, 0x2e, 0x6c, 0x69, 0x6e, 0x6b, 0x61, 0x2e,
	0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x70, 0x61, 0x74, 0x63, 0x68,
	0x2f, 0x74, 0x65, 0x73, 0x74, 0x73, 0x2f, 0x6c, 0x69, 0x6e, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_tests_lint_lint_proto_goTypes = []any{
...
func file_tests_lint_lint_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tests_lint_lint_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_tests_lint_lint_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*URL); i {
			case 0:
				return &v.state
			case 1:
		...
		file_tests_lint_lint_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*ID); i {
			case 0:
				return &v.state
			case 1:
		...
		file_tests_lint_lint_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_tests_lint_lint_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_tests_lint_lint_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*Outer); i {
			case 0:
				return &v.state
			case 1:
		...
		file_tests_lint_lint_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*Color); i {
			case 0:
				return &v.state
			case 1:
		...
		file_tests_lint_lint_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_tests_lint_lint_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_tests_lint_lint_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_tests_lint_lint_proto_msgTypes[10].Exporter = func(v any, i int) any {
	...
	file_tests_lint_lint_proto_msgTypes[4].OneofWrappers = []any{
		(*OneofMessage_ID)(nil),
		(*OneofMessage_URL)(nil),
	}
	file_tests_lint_lint_proto_msgTypes[6].OneofWrappers = []any{
		(*Color_RGB)(nil),
		(*Color_RGBA)(nil),
		(*Color_HSV)(nil),
	}
