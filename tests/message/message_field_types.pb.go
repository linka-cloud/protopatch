...
var file_tests_message_message_field_types_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x6e, 0x67, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x6f, 0x2e,
...
var file_tests_message_message_field_types_proto_goTypes = []any{
...
func file_tests_message_message_field_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tests_message_message_field_types_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_tests_message_message_field_types_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_tests_message_message_field_types_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_tests_message_message_field_types_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_tests_message_message_field_types_proto_msgTypes[1].OneofWrappers = []any{}
	file_tests_message_message_field_types_proto_msgTypes[2].OneofWrappers = []any{
