...
var file_tests_message_message_renames_proto_rawDesc = []byte{
	...
	0x6f, 0x6f, 0x6c, 0x5f, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x6f, 0x2e,
...
var file_tests_message_message_renames_proto_goTypes = []any{
...
func file_tests_message_message_renames_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tests_message_message_renames_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Frank); i {
			case 0:
				return &v.state
			case 1:
		...
		file_tests_message_message_renames_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_tests_message_message_renames_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_tests_message_message_renames_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_tests_message_message_renames_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_tests_message_message_renames_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_tests_message_message_renames_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_tests_message_message_renames_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_tests_message_message_renames_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_tests_message_message_renames_proto_msgTypes[9].Exporter = func(v any, i int) any {
	...
	file_tests_message_message_renames_proto_msgTypes[1].OneofWrappers = []any{
		(*RenamedOneofMessage_Id)(nil),
		(*RenamedOneofMessage_Name)(nil),
	}
	file_tests_message_message_renames_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
