...
var file_tests_plugin_validate_proto_goTypes = []any{
...
func file_tests_plugin_validate_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tests_plugin_validate_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_tests_plugin_validate_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_tests_plugin_validate_proto_msgTypes[2].Exporter = func(v any, i int) any {
	...
	file_tests_plugin_validate_proto_msgTypes[1].OneofWrappers = []any{
		(*IPAddress_IPV4)(nil),
		(*IPAddress_IPV6)(nil),
	}
	type x struct{}
